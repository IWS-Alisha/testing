...
(function withAngular(angular) {
  ...
  angular.module('720kb.datepicker', [])
    .directive('datepicker', ['$window', '$compile', '$locale', '$filter', '$interpolate', 'localStorageService', function manageDirective($window, $compile, $locale, $filter, $interpolate, localStorageService) {
    ...
    return {
      ...
      'link': function linkingFunction($scope, element, attr) {
        ...
        var selector = attr.selector
          ...
          , theCalendar
          , defaultPrevButton = '<b class="datepicker-default-button">prev</b>'//&lang;
          , defaultNextButton = '<b class="datepicker-default-button">next</b>'//&rang;<img src="images/rightback.png"/>
          ...
          , date = new Date(localStorageService.get('getDate'))
